  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogContent>
        ...
        <Typography variant="body2" component="p" gutterBottom>
          We will retain your personal information only for as long as is necessary for the purposes set out in this Privacy Policy. When we no longer need your personal information, we will securely delete or destroy it.
        </Typography>
        ...
        <Typography variant="body2" component="p" gutterBottom>
          Failure to comply with this Privacy Policy may result in disciplinary action or legal consequences as per applicable laws.
        </Typography>
        ...
        <Typography variant="body2" component="p" gutterBottom>
          We may update this Privacy Policy from time to time to reflect changes in our practices or legal obligations. Any updates will be posted on this page, and we encourage you to review it periodically.
        </Typography>
        ...
        <Typography variant="body2" component="p" gutterBottom> 
         ...
         <Typography variant='body2' component='p' gutterBottom> 
           This Privacy Policy is effective as of 1 Jan 2024.
         </Typography> 
      </DialogContent>
